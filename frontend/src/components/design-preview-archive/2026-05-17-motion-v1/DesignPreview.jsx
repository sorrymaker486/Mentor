...
function CursorParticles() {
  return (
    <div className="dp2-cursor-particles" aria-hidden>
    ...
    <PageShell variant="loading">
      <div className="dp2-loader">
        <div className="dp2-loader-top">
          <span>MENTOR BOOT</span>
          <span>学习画像 / 章节节点 / 本次会话</span>
        </div>
        <div className="dp2-loader-core">
          <p>正在同步你的学习现场</p>
          <h1>Mentor</h1>
          <p>准备进入可恢复、可追踪、可继续的学习路径。</p>
        </div>
    ...
    <PageShell variant="subjects">
      <div className="dp2-subjects">
        <section className="dp2-section-title">
          ...
          <h2>选择本次学习入口</h2>
          <p>页面不整体滚动，课程列表只在内部流动。每个进度会影响学习画像网络的亮度和连接。</p>
        </section>
    ...
    <PageShell variant="resources">
      <div className="dp2-resources">
        <section className="dp2-section-title">
          ...
          <h2>生成学习资源</h2>
          <p>按钮动效收窄到文字和按钮边界内，不再出现过宽的滚动光带。</p>
        </section>
        <section className="dp2-resource-grid">
        ...
        <aside className="dp2-resource-preview">
          <div>
            ...
            <h3>当前章节讲义</h3>
            <p>系统会引用当前对话、章节节点和画像网络，生成更贴近薄弱点的材料。</p>
          </div>
          <div className="dp2-actions">
    ...
    <PageShell variant="quiz">
      <div className="dp2-quiz">
        <section className="dp2-section-title">
          ...
          <h2>15 题章节小测</h2>
          <p>可以在章节结束后自动出现，也可以直接进入测试跳过当前小节。</p>
        </section>
  ...
  return (
    <PageShell variant="result">
      <div className="dp2-result">
        <section className="dp2-result-score">
          <div className="dp2-mini-label">RESULT</div>
          <h2>未达标</h2>
          <p>当前结果会在同一窗口展示答案和解析，并自动接入 AI 巩固学习。</p>
          <div className="dp2-score-ring" aria-hidden>
            <span>68</span>
          </div>
          <Button>继续 AI 巩固</Button>
        </section>
        <section className="dp2-result-list">
